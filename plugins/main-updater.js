...
cmd({
    ...
    try {
        await reply("🔍 Checking for 𝚸𝚮𝚯𝚵𝚴𝚰𝚾 updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your 𝚸𝚮𝚯𝚵𝚴𝚰𝚾 bot is already up-to-date!");
        }

        await reply("🚀 Updating 𝚸𝚮𝚯𝚵𝚴𝚰𝚾 Bot...");
        ...
        const sourcePath = path.join(extractPath, "𝚸𝚮𝚯𝚵𝚴𝚰𝚾-main");
