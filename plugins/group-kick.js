...
cmd({
  ...
  filename: __filename,
    ...
    try {
        ...
        if (!isAdmins && !isOwner) return reply("*📛 ONLY GROUP ADMINS OR THE OWNER(PHOENIX) CAN USE THIS COMMAND.*");
        // Check if the bot has admin privileges
        if (!isBotAdmins) return reply("*📛 I NEED TO BE A GROUP ADMIN TO KICK MEMBERS.*");
